...
const CompetitionsSection = () => {
  const redirectToExternalSite = () => {
    window.location.href = "https://dazzling-griffin-b44bc3.netlify.app/"; // Replace "https://www.example.com" with the URL of the external website you want to redirect to
  };
  return (
    <>
      <div
