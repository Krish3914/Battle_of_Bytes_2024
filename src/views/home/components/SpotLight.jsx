...
import neeraj from "../../../assets/images/p1.png";
import dj1 from "../../../assets/images/p2.png";
import dj2 from "../../../assets/images/p3.png";
import ferrari from "../../../assets/images/p7.png";
import sithara from "../../../assets/images/p8.png";
import babs from "../../../assets/images/p9.png";
...
const SpotLight = () => {
  ...
  const items = [neeraj, dj1, dj2, ferrari, sithara, babs];

  return (
    <section className="py-20 font-inversionz text-6xl sm:text-8xl text-karma-green">
      <div className="max-w-screen-2xl mx-auto">
        <h2 className="text-center mb-8">SPOTLIGHT & Prizes</h2>
        <motion.div
